...
//    byte[] ret = orderTransformer.doTransform(exchange, resBytes, userContext, config,null);
...
//            .getBytes();
//    orderTransformer.getTransformerId();
//    byte[] ret = portOrderListTransformer.doTransform(exchange, resBytes, userContext,
// config,null);
//    Assertions.assertNotNull(ret);
//  }
//
...
// \"status\":\"ACTIVE\"}]}"
//            .getBytes();
//    byte[] ret = listTransformer.doTransform(exchange, resBytes, userContext, config,null);
//    Assertions.assertNotNull(ret);
//  }
// }
